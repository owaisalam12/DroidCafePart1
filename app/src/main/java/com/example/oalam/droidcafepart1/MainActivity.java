...
package com.example.oalam.droidcafepart1;
...
import com.example.oalam.droidcafepart1.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String data = "geo:37.422114,-122.086744?z=12";
    ...
    public void showFoodOrder(String message) {
        ...
        Intent intent = new Intent(this, com.example.oalam.droidcafepart1.OrderActivity.class);
        startActivity(intent);
    }
